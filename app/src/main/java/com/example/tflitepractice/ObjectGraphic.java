...
public class ObjectGraphic extends GraphicsOverlay.Graphic {
    public static final String TAG = "ObjectGraphic";
    ...
    ObjectGraphic(GraphicsOverlay overlay, DetectedObject object) {
        super(overlay);
